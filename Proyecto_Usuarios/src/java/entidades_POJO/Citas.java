...
public class Citas implements Serializable {
    ...
    public Citas(String codigoCita,Usuario dniUsuario, String fecha, String hora, boolean llamado, Tramites tipoTramite) {
        this.codigoCita = codigoCita;
        this.fecha = fecha;
        this.hora = hora;
    ...
    public String toString() {
        return "entidades_POJO.Citas[ codigoCita=" + codigoCita + " ]";
    }
